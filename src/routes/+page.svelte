...
<div class="sm:hidden max-h-[95%] max-w-[90%] grid grid-rows-3 py-4
            text-gray-900 antialiased font-bacasime">
    ...
    <div class="flex flex-col gap-2 text-2xl relative top-4 px-4">
        ...
        <div class="flex gap-5 justify-center">
            <a href="https://github.com/mtzsouza" target="_blank" rel="noreferrer noopener">
                <i class="fa-brands fa-github fa-xl" style="color: #111827;"></i>
            </a>
...
<div class="hidden sm:flex max-h-[95%] max-w-[90%] grid grid-flow-col grid-cols-2 justify-around overflow-hidden
            text-gray-900 antialiased font-bacasime">
    <div class="flex flex-col gap-6 max-w-[50%] tracking-wide text-nowrap">
        <div class="text-5xl text-center font-semibold py-12">
            <h1>Full-Stack Engineer</h1>
            <h1>&</h1>
            <h1>Machine Learning Enthusiast</h1>
        </div>
